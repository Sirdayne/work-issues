...
import createchemical from "pages/agromap/notepad/checklist/add/chemical"
import createfertilizer from "pages/agromap/notepad/checklist/add/fertilizer"
import createharrowing from "pages/agromap/notepad/checklist/add/harrowing"
import createharvest from "pages/agromap/notepad/checklist/add/harvest"
import createsowing from "pages/agromap/notepad/checklist/add/sowing"

import viewchemical from "pages/agromap/notepad/checklist/view/chemical"
...
export default {
  ...
  methods: {
    afterFetch() {
      ...
      this.chemistrylimitfact = fromVuex("chemistrylimitfact");
      this.loading = false
    },
    addCheckList(id) {
