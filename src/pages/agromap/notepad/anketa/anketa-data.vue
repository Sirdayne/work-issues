...
import updatepar from "pages/agromap/notepad/anketa/update/par.vue"
import updatesev from "pages/agromap/notepad/anketa/update/sev.vue"
import updateuhod from "pages/agromap/notepad/anketa/update/uhod.vue"
import updateuborka from "pages/agromap/notepad/anketa/update/uborka.vue"
import updatevpr from "pages/agromap/notepad/anketa/update/vpr.vue"
import remove from "pages/agromap/notepad/anketa/remove.vue"
...
export default {
  ...
  methods: {
    afterFetch(){
      this.workSeason = fromVuex("workSeason")
