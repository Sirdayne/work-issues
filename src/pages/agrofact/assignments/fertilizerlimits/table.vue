...
export default {
  ...
  methods: {
    ...
    initPagination() {
      this.page.size = +localStorage.getItem("assignments/fertilizerlimits/pageSize") || 5
    ...
    handleSizeChange(num) {
      this.page.size = num
      localStorage.setItem("assignments/fertilizerlimits/pageSize", +num)
      modByLib.addTooltips(this.paginate(this.tableData));
    },
  },
}
