...
div
  el-dialog(title="Детали", :visible.sync="dialogTableVisible")
    el-select(v-model="selectedCarType" placeholder="Выбрать")
      el-option(v-for="ct in selectedCarTypes", :key="ct.value", :label="ct.label", :value="ct.value")
    el-table(:data="details")
      el-table-column(prop="0.car", label="Машина", header-align="center", align="left", width="300")
      el-table-column(prop="0.field", label="Поле", header-align="center", align="left", width="170")
      el-table-column(prop="0.work", label="Работа", header-align="center", align="left", width="170")
  el-form(:model="item", :inline="true", ref="form", :label-position="'top'")
  ...
  el-table(
    ...
    el-table-column(prop="rowHeader", label="", header-align="center", align="left")
    el-table-column(prop="tractor", label="Тракторы", header-align="center", align="right")
    el-table-column(prop="combine", label="Комбайны", header-align="center", align="right")
    el-table-column(prop="sprayer", label="Опрыскиватели", header-align="center", align="right")
    el-table-column(prop="truck", label="Камазы", header-align="center", align="right")
    el-table-column(fixed="right", label="Детали", width="110", align="center")
...
export default {
  ...
  computed: {
    ...
    carstatusextended() {
      return fromVuex("carstatusextended")
    },
    totalItems: function() {
