...
div
  ...
  el-table(
    ...
    el-table-column(prop="date.startFormated", label="Дата", header-align="center")
    el-table-column(prop="employee", label="Водитель", header-align="center")
    el-table-column(prop="car", label="Машина", header-align="center")
    el-table-column(prop="instrument", label="Орудие", header-align="center")
    el-table-column(prop="field", label="Посев", header-align="center")
    el-table-column(prop="work", label="Работа", header-align="center")
    el-table-column(prop="mileageArea", label="Площадь по пробегу", header-align="center")
    el-table-column(prop="processedSquare", label="S обработки", header-align="center")
    el-table-column(prop="areaPerHour", label="Га в час", header-align="center")
    el-table-column(prop="stopMinutesDisplayString", label="Простои", header-align="center")
    el-table-column(prop="workHourPercentage", label="% рабочего времени", header-align="center")
    el-table-column(prop="avgSpeed", label="Эксплуатационная скорость задания", header-align="center")
    el-table-column(label="Трек", fixed="right", width="130", align="center")
...
export default {
  ...
  computed: {
    assignments() {
      return fromVuex("assignments")
    },
    downtime() {
      return fromVuex("downtime")
